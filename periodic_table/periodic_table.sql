...
--
-- Name: elements uq_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements uq_symbol; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT uq_symbol UNIQUE (symbol);
...
--
-- Name: properties fk_type; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_type FOREIGN KEY (type_id) REFERENCES public.types(type_id);
